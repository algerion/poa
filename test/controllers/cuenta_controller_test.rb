...
class CuentaControllerTest < ActionController::TestCase
  ...
  test "should create cuentum" do
    assert_difference('Cuentum.count') do
      post :create, cuentum: { cuenta: @cuentum.cuenta, descripcion: @cuentum.descripcion, detalle: @cuentum.detalle, fin: @cuentum.fin, inicio: @cuentum.inicio }
    end
  ...
  test "should update cuentum" do
    patch :update, id: @cuentum, cuentum: { cuenta: @cuentum.cuenta, descripcion: @cuentum.descripcion, detalle: @cuentum.detalle, fin: @cuentum.fin, inicio: @cuentum.inicio }
    assert_redirected_to cuentum_path(assigns(:cuentum))
  end
